...
touch manjaro-minimal.img
truncate -s 4G manjaro-minimal.img

losetup -D
losetup -fP --show manjaro-minimal.img
...
pacstrap -C ./manjaro.conf -K /mnt base \
                archlinux-keyring archlinuxarm-keyring manjaro-keyring manjaro-arm-keyring\
...
# lzfse -encode -i manjaro-minimal.img -o ../manjaro-minimal.img.lzfse
xz -vkc --format=lzma -9e manjaro-minimal.img > ../manjaro-minimal.img.lzma
